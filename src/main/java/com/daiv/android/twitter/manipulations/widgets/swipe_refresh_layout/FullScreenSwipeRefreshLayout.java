package com.daiv.android.twitter.manipulations.widgets.swipe_refresh_layout;
...
public class FullScreenSwipeRefreshLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        ResourceHelper helper = new ResourceHelper(getContext(), "com.daiv.android.twitter");

...
package com.daiv.android.twitter.manipulations;
...
import com.daiv.android.twitter.adapters.emoji.NatureEmojiAdapter;
import com.daiv.android.twitter.adapters.emoji.OtherEmojiAdapter;
import com.daiv.android.twitter.adapters.emoji.PeopleEmojiAdapter;
import com.daiv.android.twitter.adapters.emoji.RecentEmojiAdapter;
import com.daiv.android.twitter.adapters.emoji.ThingsEmojiAdapter;
import com.daiv.android.twitter.adapters.emoji.TransEmojiAdapter;
import com.daiv.android.twitter.data.sq_lite.EmojiDataSource;
import com.daiv.android.twitter.data.sq_lite.Recent;
...
public class EmojiKeyboard extends LinearLayout {
    ...
    protected void onFinishInflate() {
        try {
            try {
                getContext().getPackageManager().getPackageInfo("com.daiv.android.emoji_keyboard_trial", PackageManager.GET_META_DATA);
            } catch (Exception e) {
                getContext().getPackageManager().getPackageInfo("com.daiv.android.emoji_keyboard_trial_ios", PackageManager.GET_META_DATA);
            }

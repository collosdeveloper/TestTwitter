...
package com.daiv.android.twitter.ui.tweet_viewer.fragments;
...
import com.daiv.android.twitter.adapters.AutoCompleteHashtagAdapter;
import com.daiv.android.twitter.adapters.AutoCompletePeopleAdapter;
import com.daiv.android.twitter.data.App;
import com.daiv.android.twitter.data.sq_lite.FollowersDataSource;
import com.daiv.android.twitter.data.sq_lite.HashtagDataSource;
import com.daiv.android.twitter.manipulations.ExpansionAnimation;
import com.daiv.android.twitter.manipulations.widgets.HoloEditText;
import com.daiv.android.twitter.services.SendTweet;
import com.daiv.android.twitter.settings.AppSettings;
import com.daiv.android.twitter.ui.compose.ComposeActivity;
import com.daiv.android.twitter.manipulations.EmojiKeyboard;
import com.daiv.android.twitter.manipulations.QustomDialogBuilder;
import com.daiv.android.twitter.utils.EmojiUtils;
import com.daiv.android.twitter.utils.ImageUtils;
import com.daiv.android.twitter.utils.Utils;
import com.daiv.android.twitter.utils.api_helper.TwitterMultipleImageHelper;
import com.daiv.android.twitter.utils.text.TextUtils;
...
public class TweetFragment extends Fragment {
    ...
    public void setUIElements(final View layout) {
        ...
        if (!addonTheme) {
            ...
            favoriteButton = layout.findViewById(R.id.favorite);
            quote = (ImageButton) layout.findViewById(R.id.quote_button);
            retweetButton = layout.findViewById(R.id.retweet);
        ...
        if(picture && pictureIv != null) { // if there is a picture already loaded
            Log.v("Test_picture_loading", "picture load started");
    ...
    public void attachClick() {
        context.sendBroadcast(new Intent("com.daiv.android.twitter.ATTACH_BUTTON"));
        ...
        builder.setItems(R.array.attach_options, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                if(item == 0) { // take picture
                    ...
                    File f = new File(Environment.getExternalStorageDirectory() + "/Test/", "photoToTweet.jpg");
    ...
    public void onActivityResult(int requestCode, int resultCode,
        ...
        switch(requestCode) {
            ...
            case CAPTURE_IMAGE:
                if (resultCode == Activity.RESULT_OK) {
                    Uri selectedImage = Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/Test/", "photoToTweet.jpg"));
            ...
            case PWICCER:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Log.v("Test_pwiccer", "length = " + currText.length());
                    Log.v("Test_pwiccer", currText);

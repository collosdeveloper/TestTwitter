...
import com.daiv.android.twitter.adapters.ActivityCursorAdapter;
import com.daiv.android.twitter.data.sq_lite.ActivityDataSource;
import com.daiv.android.twitter.services.ActivityRefreshService;
import com.daiv.android.twitter.services.SecondActivityRefreshService;
...
public class ActivityFragment extends MainFragment {
    ...
    public void onResume() {
        ...
        filter.addAction("com.daiv.android.twitter.REFRESH_ACTIVITY");
        filter.addAction("com.daiv.android.twitter.NEW_ACTIVITY");
    ...
    public void getCursorAdapter(boolean showSpinner) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    Log.v("Test_databases", "mentions cursor size: " + cursor.getCount());
                } catch (Exception e) {
                    ActivityDataSource.dataSource = null;
                    getCursorAdapter(true);
                    return;

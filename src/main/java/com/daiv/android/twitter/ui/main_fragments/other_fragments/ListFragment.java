...
public class ListFragment extends MainFragment {
    ...
    public void onResume() {
        ...
        filter.addAction("com.daiv.android.twitter.RESET_LISTS");
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    context.sendBroadcast(new Intent("com.daiv.android.twitter.RESET_LISTS"));
                    return;
                }
                ...
                context.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (cursorAdapter != null) {
                            ...
                            Log.v("Test_cursor", c.getCount() + " tweets in old list");
                        }

                        try {
                            Log.v("Test_list", "number of tweets in list: " + cursor.getCount());
                        } catch (Exception e) {
                            e.printStackTrace();

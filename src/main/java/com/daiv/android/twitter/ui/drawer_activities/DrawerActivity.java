...
package com.daiv.android.twitter.ui.drawer_activities;
...
import com.daiv.android.twitter.adapters.InteractionsCursorAdapter;
...
import com.daiv.android.twitter.data.sq_lite.*;
import com.daiv.android.twitter.listeners.InteractionClickListener;
import com.daiv.android.twitter.listeners.MainDrawerClickListener;
...
import com.daiv.android.twitter.ui.LoginActivity;
...
import com.daiv.android.twitter.utils.XmlFaqUtils;
...
public abstract class DrawerActivity extends Activity {
            ...
            if (current == 1) {
                ...
                secondAccount.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (canSwitch) {
                            context.sendBroadcast(new Intent("com.daiv.android.twitter.STOP_PUSH_SERVICE"));
                            context.sendBroadcast(new Intent("com.daiv.android.twitter.MARK_POSITION").putExtra("current_account", current));
    ...
    private void logoutFromTwitter() {
        ...
        context.sendBroadcast(new Intent("com.daiv.android.STOP_PUSH_SERVICE"));
                ...
                .setItems(new CharSequence[] {"Twitter", "Google+", "Email"}, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i == 0) {
                            ...
                            new AlertDialog.Builder(context)
                                    .setItems(new CharSequence[] {"@TestAndroid", "@daiv"}, new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            if (i == 0) {
    ...
    public void showFollowDialog() {
        new AlertDialog.Builder(context)
                .setItems(new CharSequence[] {"@TestAndroid", "@daiv", "'s Google+"}, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

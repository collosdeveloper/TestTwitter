...
package com.daiv.android.twitter.ui.drawer_activities.discover;
...
import com.daiv.android.twitter.adapters.TrendsArrayAdapter;
...
public class NearbyTweets extends Fragment implements
    ...
    private double[] getLocationFromYahoo(int woeid) {
        ...
        Log.v("Test_loc", "lat: " + loc[0] + " long: " + loc[1]);

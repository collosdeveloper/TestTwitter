...
public class StartPull extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.v("Test_launcher", "starting pull from launcher service");
        ...
        if (AppSettings.getInstance(this).pushNotifications && !TestPullNotificationService.isRunning) {
            startService(new Intent(this, TestPullNotificationService.class));
        }
    }
}

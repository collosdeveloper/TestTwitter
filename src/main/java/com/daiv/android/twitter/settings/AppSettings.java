...
import com.daiv.android.twitter.APIKeys;
...
public class AppSettings {
    ...
    public static final int QUOTE_STYLE_Test = 1;
    ...
    public AppSettings(Context context) {
        ...
        layout = Integer.parseInt(sharedPrefs.getString("layout", "0")); // default is Test
        ...
        // theme stuff
        roundContactImages = layout == LAYOUT_Test;
        ...
        if (sharedPrefs.getBoolean("addon_themes", false)) {
            ...
            try {
                ...
                roundContactImages = metaData.getBoolean("Test_theme_round_contact_pictures");
                translateProfileHeader = metaData.getBoolean("Test_theme_contracting_user_backgrounds");
                backgroundColor = Color.parseColor(metaData.getString("Test_theme_background_color"));
                try {
                    accentColor = metaData.getString("Test_theme_accent_color");
                ...
                String theme = metaData.getString("Test_theme_base");
    ...
    public AppSettings(SharedPreferences sharedPrefs, Context context) {
        ...
        if (sharedPrefs.getInt("current_account", 1) == 1) {
            ...
            Log.v("Test_username", myScreenName);
        } else {
            authenticationToken = sharedPrefs.getString("authentication_token_2", "none");
            authenticationTokenSecret = sharedPrefs.getString("authentication_token_secret_2", "none");
            secondAuthToken = sharedPrefs.getString("authentication_token_1", "none");

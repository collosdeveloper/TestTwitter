...
package com.daiv.android.twitter.settings;
...
import com.daiv.android.twitter.data.Item;
import com.daiv.android.twitter.data.sq_lite.FollowersDataSource;
import com.daiv.android.twitter.data.sq_lite.HomeDataSource;
import com.daiv.android.twitter.utils.*;
import com.daiv.android.twitter.services.DirectMessageRefreshService;
import com.daiv.android.twitter.services.MentionsRefreshService;
...
import com.daiv.android.twitter.ui.main_fragments.other_fragments.DMFragment;
import com.daiv.android.twitter.fragments.HomeFragment;
import com.daiv.android.twitter.ui.main_fragments.other_fragments.MentionsFragment;
import com.daiv.android.twitter.manipulations.widgets.HoloEditText;
import com.daiv.android.twitter.manipulations.widgets.HoloTextView;
...
public class PrefFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void setUpPageSettings() {
        ...
        drawerItems.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                final SharedPreferences sharedPrefs = context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
                ...
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                File des = new File(Environment.getExternalStorageDirectory() + "/Test/backup.prefs");
    ...
    public void setUpTimelinesSettings() {
        final SharedPreferences sharedPrefs = getActivity().getSharedPreferences("com.daiv.android.twitter_world_preferences",
                Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);
    ...
    public void setUpThemeSettings() {
        ...
        download.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                try {
                    File f = new File(Environment.getExternalStorageDirectory() + "/Download/" + "daiv-apps-portal.apk");
                    f.delete();
                } catch (Exception e) {
                ...
                DownloadManager.Request request = new DownloadManager.Request(
                        Uri.parse("http://daivapps.com/dev-upload/repository/ldaiv/daiv-apps-portal.apk"));
                final long enqueue = dm.enqueue(request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI|DownloadManager.Request.NETWORK_MOBILE)
                        .setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "daiv-apps-portal.apk"));
                        ...
                        if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(action)) {
                            ...
                            if (c.moveToFirst()) {
                                ...
                                if (DownloadManager.STATUS_SUCCESSFUL == c
                                    ...
                                    install.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/Download/" + "daiv-apps-portal.apk")), "application/vnd.android.package-archive");
        ...
        addonTheme.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                for (int i = 0; i < packages.size(); i++) {
                    ...
                    try {
                        boolean theme = metaData.getString("Test_theme").startsWith("version");
                        if (!theme) {
                            packages.remove(i--);
                        }
                    } catch (Exception e) {
                ...
                if (!((CheckBoxPreference) emojis).isChecked() && !EmojiUtils.checkEmojisEnabled(context)) {
                    new AlertDialog.Builder(context)
                            ...
                            .setPositiveButton(R.string.get_android, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.emoji_keyboard_trial")));
                                }
                            })
                            .setNegativeButton(R.string.get_ios, new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.emoji_keyboard_trial_ios")));
                                }
                            })
                            .create()
                            .show();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPrefs, String key) {
        ...
        SharedPreferences worldPrefs = getActivity().getSharedPreferences("com.daiv.android.twitter_world_preferences",
                Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);
    ...
    class FillGaps extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... urls) {
            ...
            try {
                ...
                context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
    ...
    public void setUpGetHelpSettings() {
        ...
        email.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"support@daivapps.com"});
        ...
        Preference followTest = findPreference("follow_Test");
    ...
    public void setUpOtherAppSettings() {
        ...
        evolve.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.evolve_sms")));
                return false;
            }
        });
        ...
        blur.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.launcher")));
                return false;
            }
        });
        ...
        source.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.reader")));
                return false;
            }
        });
        ...
        spotlight.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.theme_spotlight")));
                return false;
            }
        });
        ...
        sm.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.messaging_donate")));
                return false;
            }
        });
        ...
        smTheme.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.messaging_theme")));
                return false;
            }
        });
        ...
        keyboardUnlock.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.emoji_keyboard")));
                return false;
            }
        });
        ...
        halopop.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.halopop")));
                return false;
            }
        });
        ...
        floatingwindows.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.floating_window")));
                return false;
            }
        });
        ...
        slideover.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.ldaiv.android.slideovermessaging")));
                return false;
            }
        });

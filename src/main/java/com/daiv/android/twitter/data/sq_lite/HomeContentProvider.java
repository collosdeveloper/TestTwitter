...
public class HomeContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.daiv.android.twitter.provider";
    ...
    private boolean checkUID(Context context) {
        ...
        for (ApplicationInfo packageInfo : packages) {
            if(packageInfo.packageName.equals("com.daiv.android.twitter")){
                //get the UID for the selected app
                twitterUid = packageInfo.uid;
            }
            if(packageInfo.packageName.equals("com.daiv.android.launcher")){
                //get the UID for the selected app
                launcherUid = packageInfo.uid;
            }
        }

        return callingUid == launcherUid || callingUid == twitterUid;
    }
    ...
    public synchronized int update(Uri uri, ContentValues values, String selection,
        ...
        if (positionSent) {
            ...
            int account = Integer.parseInt(selectionArgs[0]);
            Log.v("Test_launcher_stuff", "id: " + id);

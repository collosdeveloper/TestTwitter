...
public class StopPull extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        SharedPreferences sharedPreferences = getSharedPreferences("com.daiv.android.twitter_world_preferences",
        ...
        sendBroadcast(new Intent("com.daiv.android.twitter.STOP_PUSH_SERVICE"));
    }
}

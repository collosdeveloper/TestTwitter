...
package com.daiv.android.twitter.utils.api_helper;
...
public class TweetMarkerHelper extends APIHelper {
    ...
    public TweetMarkerHelper(int currentAccount, String screenname, Twitter twitter, SharedPreferences sharedPrefs) {
        ...
        postURL = "https://api.tweetmarker.net/v2/lastread?api_key=" +
    ...
    public boolean sendCurrentId(String collection, long id) {
        try {
            ...
            Log.v("Test_tweetmarker", "sending " + id + " to " + screenname);
            ...
            Log.v("Test_tweetmarker", "sending response code: " + responseCode);
    ...
    public boolean getLastStatus(String collection, final Context context) {
        ...
        try {
            ...
            Log.v("Test_tweetmarker", "getting id response code: " + response.getStatusLine().getStatusCode() + " for " + screenname);
            ...
            if (statusLine.getStatusCode() == 500 || statusLine.getStatusCode() == 503) {
                ...
                if (timeline != null) {
                    ...
                    Log.v("Test_tweetmarker", "getting tweetmarker," +
                            " version: " + version +
                            " id: " + currentId +
        ...
        Log.v("Test_launcher_stuff", "writing " + currentId + " to shared prefs");

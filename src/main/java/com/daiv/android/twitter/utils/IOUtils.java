...
public class IOUtils {
    ...
    public static boolean loadSharedPreferencesFromFile(File src, Context context) {
        ...
        try {
            ...
            SharedPreferences.Editor prefEdit = context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
    ...
    public static boolean saveSharedPreferencesToFile(File dst, Context context) {
        ...
        try {
            ...
            SharedPreferences pref = context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
                    Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);

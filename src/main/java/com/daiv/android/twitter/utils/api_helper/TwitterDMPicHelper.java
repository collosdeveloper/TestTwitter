...
public class TwitterDMPicHelper {
    ...
    public Bitmap getDMPicture (String picUrl, Twitter twitter) {
        ...
        try {
            ...
            Log.v("Test_dm_image", "endpoint_host: " + twitter_endpoint_host);
            Log.v("Test_dm_image", "endpoint_path: " + twitter_endpoint_path);
            ...
            HttpProcessor httpproc = new ImmutableHttpProcessor(// Required protocol interceptors
                    new RequestContent(),
            ...
            if (statusCode == 200 || statusCode == 302) {
                ...
                Log.v("Test_dm_image", statusCode + "");
            }

...
public class UpdateUtils {
    ...
    public static void updateToGlobalPrefs(final Context context) {
        new AlertDialog.Builder(context)
                ...
                .setMessage("Test has to update your settings preferences to prepare for some new things. This will override any old settings backups.")
    ...
    public static void versionThreeDialog(final Context context) {
        new AlertDialog.Builder(context)
                ...
                .setMessage("With version 3.0.0, Test has added support for our latest project, Blur, which is daiv Apps launcher.\n\n" +
                        "It does some very cool interfacing with Test, basically having the full app just one swipe away on your launcher. It has been a great project to work on and I recommend checking it out, it is completely free!\n\n" +
                        "Head over to the Play Store description for Blur to learn more about getting Test compatible (it is just downloading one extension app).\n\n" +
                        "Hope you like it!")
                .setPositiveButton("Go to Blur!", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent web = new Intent(Intent.ACTION_VIEW);
                        web.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.daiv.android.launcher"));

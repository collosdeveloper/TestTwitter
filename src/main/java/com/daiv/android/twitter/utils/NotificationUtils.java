...
import com.daiv.android.twitter.receivers.NotificationDeleteReceiverOne;
import com.daiv.android.twitter.receivers.NotificationDeleteReceiverTwo;
import com.daiv.android.twitter.services.MarkReadSecondAccService;
import com.daiv.android.twitter.services.MarkReadService;
import com.daiv.android.twitter.services.ReadInteractionsService;
import com.daiv.android.twitter.settings.AppSettings;
import com.daiv.android.twitter.ui.MaterialMainActivity;
import com.daiv.android.twitter.utils.redirects.RedirectToMentions;
...
public class NotificationUtils {
    ...
    public static Bitmap getIcon(Context context, int[] unreadCount, String screenname) {
        ...
        if (screenname != null && customPic) {
            ...
            Log.v("notifications_Test", "in screenname");
            String url;
            try {
                ...
                Log.v("notifications_Test", "got wrapper");

                if (wrapper == null) {

                    Log.v("notifications_Test", "wrapper null");
    ...
    public static void makeFavsNotificationToActivity(ArrayList<String[]> tweets, Context context) {
        ...
        SharedPreferences.Editor e = context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
    ...
    public static void makeFavsNotification(ArrayList<String[]> tweets, Context context, boolean toDrawer) {
        ...
        if (settings.notifications) {
            ...
            // Pebble notification
            if(context.getSharedPreferences("com.daiv.android.twitter_world_preferences",
    ...
    public static void sendToLightFlow(Context context, String title, String message) {
        Intent data = new Intent("com.daiv.android.twitter.NEW_NOTIFICATION");

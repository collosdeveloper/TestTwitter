...
package com.daiv.android.twitter.utils.text;
...
public class TouchableSpan extends ClickableSpan {
    ...
    public void onClick(View widget) {
        if (Patterns.WEB_URL.matcher(mValue).find()) {
            ...
            if (fromLauncher) {
                ...
                search.setComponent(new ComponentName("com.daiv.android.twitter",
                        "com.daiv.android.twitter.ui.drawer_activities.discover.trends.LauncherSearchedTrends"));
            ...
            if (fromLauncher)  {
                ...
                user.setComponent(new ComponentName("com.daiv.android.twitter",
                        "com.daiv.android.twitter.ui.profile_viewer.LauncherProfilePager"));
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                switch (i) {
                    case 0: // search hashtag
                        ...
                        break;
                    case 1: // mute hashtag
                        SharedPreferences sharedPreferences = mContext.getSharedPreferences("com.daiv.android.twitter_world_preferences",
    ...
    public void longClickMentions() {
        ...
        builder.setItems(R.array.long_click_mentions, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                final SharedPreferences sharedPrefs = mContext.getSharedPreferences("com.daiv.android.twitter_world_preferences",
                        Context.MODE_WORLD_READABLE + Context.MODE_WORLD_WRITEABLE);

...
package com.daiv.android.twitter.adapters.emoji;
...
public class RecentEmojiAdapter extends BaseEmojiAdapter {
    ...
    public RecentEmojiAdapter(Context context, EmojiKeyboard keyboard, ArrayList<Recent> recents) {
        ...
        try {
            res = context.getPackageManager().getResourcesForApplication("com.daiv.android.emoji_keyboard_trial");
        } catch (Exception e) {
            try {
                res = context.getPackageManager().getResourcesForApplication("com.daiv.android.emoji_keyboard_trial_ios");
            } catch (Exception f) {

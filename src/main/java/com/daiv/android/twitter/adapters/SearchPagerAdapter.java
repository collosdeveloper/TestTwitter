...
import com.daiv.android.twitter.ui.search.TimelineSearchFragment;
import com.daiv.android.twitter.ui.search.TwitterSearchFragment;
import com.daiv.android.twitter.ui.search.UserSearchFragment;
...
public class SearchPagerAdapter extends FragmentPagerAdapter {
    ...
    public SearchPagerAdapter(FragmentManager fm, Context context, boolean onlyId, boolean onlyProfile, String query, boolean translucent) {
        ...
        Log.v("Test_searching", "query: " + query);
    }

...
import com.daiv.android.twitter.utils.SDK11;
import com.daiv.android.twitter.utils.Utils;
import com.daiv.android.twitter.utils.api_helper.TwitterDMPicHelper;
...
public class TimeLineCursorAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, Context mContext, final Cursor cursor) {
        ...
        if (!settings.addonTheme && TestLayout == AppSettings.LAYOUT_FULL_SCREEN ||

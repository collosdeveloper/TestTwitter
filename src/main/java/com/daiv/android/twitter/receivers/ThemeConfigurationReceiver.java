...
public class ThemeConfigurationReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION = "com.daiv.android.SET_THEME";
    public static final String ARG_PACKAGE_NAME = "com.daiv.android.THEME_PACKAGE_NAME";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            String themeType = metaData.getString("Test_theme");
            if (themeType == null) {
            	return;
            }

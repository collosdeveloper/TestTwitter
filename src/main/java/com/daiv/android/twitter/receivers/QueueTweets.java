...
import com.daiv.android.twitter.services.SendQueue;
...
public class QueueTweets extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        Log.v("Test_queued", "connectivity change: just starting receiver");
        ...
        if (Utils.hasInternetConnection(context) &&
            ...
            Log.v("Test_queued", "setting alarm for queue");
